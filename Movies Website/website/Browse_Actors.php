...
<div class="title">
<span id="font2">Actor Information</span>
</div>
...
print '<strong>Profile</strong><br><br>';

$row = mysql_fetch_row($result);

print 'First Name: '.$row[2].'<br>';
...
$query = 'select m.title, ma.role, m.id from Movie m, MovieActor ma where m.id=ma.mid AND ma.aid='.$id.' order by m.title;';
...
print '<strong>Acted In</strong><br><br>';
